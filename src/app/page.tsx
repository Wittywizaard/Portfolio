...
const experiences = [
  ...
  },
  {
    ...
    points: [
      'Identified and assessed 50+ security vulnerabilities by conducting VAPT across systems and applications, enabling faster remediation and reducing potential security risks.',
      'Developed a digital forensic solution, Lost Data Retrieval, to improve file recovery efficiency and support ransomware-related data recovery workflows.',
      'Improved remediation turnaround by collaborating with stakeholders to deliver risk-prioritized mitigation strategies and actionable security recommendations.',
    ],
  },
];
        ...
        <section id="achievements" className="relative border-t border-white/5 px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 flex flex-col gap-6 xl:flex-row xl:items-start">
              ...
              >
                <p className="text-sm uppercase tracking-[0.35em] text-slate-500">Google Project Management Certification</p>
                ...
                <div className="mt-8 space-y-4 text-slate-300">
                  <div className="grid gap-4 sm:grid-cols-[auto_1fr] sm:items-center">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-base">workwithtanyaaa@gmail.com</p>
                    </div>
                  </div>
